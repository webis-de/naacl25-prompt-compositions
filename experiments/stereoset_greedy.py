...
def main(args: argparse.Namespace):
    ...
    script_logger.info(f"Stereoset loaded: {stereoset_data.keys()}")
    ...
    for combination in prompt_component_combinations:
        ...
        for seed in args.seeds:
            ...
            prompts = create_bias_prompts_from_base_template(
                ...
                all_categories=[category.value for category in Stereoset_bias_categories],
            ...
            save_results(
                args, stereoset_data, output, label_dist, pred_label, seed, combination, prompts
            )
